...
vertex_buffer = luisa.Buffer(len(cbox_vertices), float3)
vertex_arr = [[*item, 0.0] for item in cbox_vertices]
...
w = Window("Path Tracing", res, resizable=False, frame_rate=True)
